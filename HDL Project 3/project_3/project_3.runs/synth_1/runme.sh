...
HD_PWD='C:/Users/Barli/Desktop/HDL Projects/project_3/project_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FirstVGA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FirstVGA.tcl
