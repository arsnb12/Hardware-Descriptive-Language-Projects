...
HD_PWD='C:/Users/Barli/Desktop/HDL Projects/project_3/project_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FirstVGA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FirstVGA.tcl -notrace
